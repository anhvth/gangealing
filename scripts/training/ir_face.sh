...
torchrun --nproc_per_node=1 train_cluster_classifier.py \
--ckpt results/ir_face/checkpoints/0080000.pt --padding_mode border \
--vis_every 500 --ckpt_every 5000 --iter 5500 --period 5000 --loss_fn lpips --exp-name ir_face_cluster_classifier \
--num_heads 3  --ndirs 1 --inject 5 --sample_from_full_res
